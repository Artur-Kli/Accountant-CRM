<template>
  <div>
    <div class="page-title">
      <h3>{{'Record_New_Record' | localize}}</h3>
    </div>
    ...
    >
      {{'Record_No_Categories' | localize}}. <router-link to="/categories">{{'Record_Add_Category' | localize}}</router-link>
    </p>
    ...
    <form class="form" v-else @submit.prevent="handleSubmit">
      <div class="input-field" >
        ...
        <label>{{'Record_Selected_Category' | localize}}</label>
      </div>
      ...
      <div class="input-field">
        ...
        <span
          ...
          >
            {{'Record_Min_Value' | localize}} {{$v.amount.$params.minValue.min}}
          </span>
      </div>
  ...
  methods: {
    async handleSubmit () {
      ...
      if (this.canCreateRecord) {
        ...
        this.$message(`${localizeFilter('Record_No_Money')} (${this.amount - this.info.bill})`)
      }
    }
  },
  destroyed() {
